...
<div class="modal fade" id="LogoutModal" tabindex="-1" aria-labelledby="LogoutModalLabel" aria-hidden="true">
    ...
    <nav style="position: sticky;top: 0px;width: 100% !important;z-index: 999999;">
        <div class="nav-container">
            ...
            <div class="nav-child-3">
                    ...
                    <div id="dropdown-content-drop">
                        @if (Auth::user())
                            ...
                            <a style="cursor: pointer;;border-top: 2px solid rgb(226, 226, 226);border-top-left-radius: 0px;border-top-right-radius: 0px"
                                data-bs-toggle="modal" data-bs-target="#LogoutModal"  onclick="closeDropdown()"><span>Logout</span></a>
                        @else
                ...
                <div>
                    <a class="nav-icon-buttons" id="cart-btn-1" href="{{route('home')}}"><i
                            class="fa-regular fa-cart-shopping-fast nav-icons"></i></a>
                    <a class="nav-icon-buttons" id="cart-btn-2" href="{{route('home')}}" ><i
                            class="fa-regular fa-cart-shopping-fast nav-icons"></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="main-container pt-4" style="align-items: center !important;justify-content: center !important;">
