            ...
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('admin.create-subcategory') }}" class="btn btn-primary">New Sub Category</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                                ...
                                @if ($subcategories->isNotEmpty())
                                    @foreach ($subcategories as $subcategory)
                                        <tr wire:key="{{$subcategory->id}}">
                                            ...
                                            @elseif ($subcategory->status == 0 || $subcategory->status == null)
                                            ...
                                            <td>
                                                <a href="{{route('admin.update-subcategory',$subcategory->id)}}">
                                                ...
                                                <a wire:confirm="Are You Sure?" wire:confirm-text="Delete" wire:click="deleteSubCategory({{$subcategory->id}})" style="cursor: pointer" class="text-danger w-4 h-4 mr-1">
                                                    <svg
