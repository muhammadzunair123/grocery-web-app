                                    ...
                                    @foreach ($products as $product)
                                        <tr wire:key={{ $product->id }}>
                                            ...
                                            @if (!empty($productImage->image))
                                                <td><img src="{{ asset('storage/' . $productImage->image) }}" class="img-thumbnail" width="50"></td>
                                            @else
                                                <td><img src="{{ asset('admin-assets/img/empty-folder.png') }}" class="img-thumbnail" width="50"></td>
                                            @endif
                                            ...
                                            <td>
                                                ...
                                                @elseif ($product->status == 0 || $product->status == null)
...
{{-- @push('script')
    <script data-navigate-once src="{{ asset('admin-assets/js/adminlte.min.js') }}"></script>
@endpush --}}
