                                    ...
                                    @foreach ($categories as $category)
                                        <tr wire:key="{{ $category->id }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif ($category->status == 0 || $category->status == null)
                                            ...
                                            <td>
                                                ...
                                                <a wire:confirm="Are You Sure?" wire:confirm-text="Delete" wire:click="deleteCategory({{$category->id}})" style="cursor: pointer" class="text-danger w-4 h-4 mr-1">
                                                    <svg
