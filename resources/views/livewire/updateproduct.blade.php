                ...
                <form action="" wire:submit.prevent="updateProduct">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="card mb-3" id="MainImageSection">
                                <div class="card-body">
                                    <div class="mb-3">
                                ...
                                <div class="container text-left pb-2 p-3">
                                    @if ($oldImages)
                                        <h5>Old Images</h5>
                                        <div class="row align-items-start">
                                            @foreach ($oldImages as $image)
                                                <div class="col d-flex flex-column" style="justify-content: center">
                                                    <img style="border-radius: 10px;border:2px solid black;box-shadow:0 .1rem .5rem rgba(0,0,0,.15)"
                                                        width="100px" src="{{ asset('storage/' . $image->image) }}"
                                                        alt="">
                                                    <a wire:click="destroy_Image({{ $image->id }})"
                                                        class="btn btn-danger mt-1"
                                                        style="width:max-content">Delete</a>
                                                </div>
                                            @endforeach
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input wire:model='barcode' type="text" name="barcode" id="barcode"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <input wire:model='qty' type="number" min="0" name="qty"
                                                id="qty" class="form-control @error('qty') is-invalid @enderror"
                                                placeholder="Qty">
                                            @error('qty')
                                                <p class="invalid-feedback">
                                                    {{ $message }}
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select wire:model.live="subcategory_id" name="sub_category" id="sub_category"
                                        class="form-control">
